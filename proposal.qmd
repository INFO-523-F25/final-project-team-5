...
We ultimately chose this dataset as a team because we wanted to analyze the stock market. Furthermore, this particular dataset had very reliable sources along with being a clean, complete set of data, so we knew that this was a trustworthy dataset that would be ready for analysis.
