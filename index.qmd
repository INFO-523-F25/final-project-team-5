...
#### Summary of Model Performance - Question 1

| Model | R² | MSE |
|------|--------|---------|
| Ridge | 0.103 | 53.178 |
| Random Forest | 0.965 | 2.096 |
| Lasso | 0.5605 | 0.0479 |
| Gradient Boost Regression | 0.9626| 0.0040 |

#### Summary of Model Performance - Question 2

| Model | R² | MSE |
|------|--------|---------|
| LTSM | -9.715 | 4.6914 |
| Prophet | 0.5618| 0.0478 |
